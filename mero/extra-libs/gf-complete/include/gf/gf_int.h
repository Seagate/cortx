 ...
 *
 * ==========================================================================
 * INTERNAL CODE FOR GALOIS FIELD ROUTINES.  THIS IS NOT MEANT FOR USERS TO
 * INCLUDE, BUT FOR THE INTERNAL GF FILES TO USE.
 * ==========================================================================
 * THIS HEADER IS NOT INCLUDED INTO ANY INTERFACE HEADER, SO *NOW* STRUCTURES
 * FROM HERE ARE AVALABLE ONLY TO LIBRARY INTERNALS.
 * AND LET IT BE SO...
 * ==========================================================================
 */
...
# define assert(cond) if (!cond) BUG()
# define exit(e) BUG()
# define bzero(dest, bytes) memset(dest, 0, bytes)
# define GF_EXPORTED(s) EXPORT_SYMBOL(s)
#else
# include <assert.h>
# include <stdio.h>
# include <getopt.h>
