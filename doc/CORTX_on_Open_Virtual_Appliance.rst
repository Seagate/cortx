...
#. From `our release page <https://github.com/Seagate/cortx/releases/tag/VA>`_, download and then uncompress the `cortx-va-1.0.1.zip https://github.com/Seagate/cortx/releases/download/VA/cortx-va-1.0.2.zip`_ file that contains the virtual machine image.
