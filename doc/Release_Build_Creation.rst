...
- Single-Node VM deployment
  ...
  - Ensure the VM is created with minimum of total 9 attached raw disks (additional disks apart from main bootable disk) per node

    - Data Disks - Min 8 Disks per node (Capacity 10G+)
