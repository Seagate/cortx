...
- To perform the S3 IO operations,refer to these instructions in [S3 IO Operations](https://github.com/Seagate/cortx/blob/main/doc/ova/2.0.0/PI-5/s3_io_operations.md "S3 IO Operations")
