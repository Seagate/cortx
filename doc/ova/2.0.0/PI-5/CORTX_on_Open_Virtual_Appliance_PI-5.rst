...
- Download the `CORTX OVA < >`_ from `our release page <https://github.com/Seagate/cortx/releases/latest>`_.
...
#. To perform the S3 IO operations,refer to these instructions in [S3 IO Operations](https://github.com/Seagate/cortx/blob/k8-ova-pi5/doc/ova/2.0.0/PI-5/aws_cli_on_same_vm.md "S3 IO Operations")
...
- Jan 03, 2021: Mukul Malhotra (mukul.malhotra@seagate.com) on a Windows laptop with VMWare Workstation 16 Pro.
