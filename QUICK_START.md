...
1. Run it on AWS using Kubernetes: [LINK](./cortx-k8s/blob/stable/doc/cortx-aws-k8s-installation.md)
1. Build entire CORTX into binaries: [LINK](./doc/community-build/docker/cortx-all/README.md)
    1. Run it on a single node: [LINK](./cortx-k8s/blob/stable/doc/cortx-aws-k8s-installation.md)
