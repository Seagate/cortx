...
1. Run it on AWS in Kubernetes: [LINK](https://github.com/Seagate/cortx-k8s/blob/stable/doc/cortx-aws-k8s-installation.md)
2. Build entire CORTX into binaries: [LINK](./doc/community-build/docker/cortx-all/README.md)
