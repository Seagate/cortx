...
5. Build entire CORTX into OVA (virtual machine image): TODO
    ...
    1. Run it on a cluster: TODO
1. Install CORTX on Supermicro Servers with Seagate RBOD Storage: [requirements verification](doc/Install_CORTX_on_Supermicro_Servers_with_Seagate_RBOD_Storage.md)
